...
function tst_onit() {
  ...
  var possArgVals = tst_countWindowCalls()
      ...
      for (var it = 0; it < tl; it++) {
        ...
        if (typeof window[funcname] === 'function') {
          if (thetest["procd"]["testobj"] || thetest["procd"]["testobj"] == 0) { //javascript
            ...
            //var torun = thetest["procd"]["testobj"]
          } else {
            var torun = undefined
          }
            ...
            if (typeof window[funcname] == "function") {
              ...
              if (possArgVals.indexOf(numOfArgs) > -1) {
                ...
                try {
                  var res = window[fstr](funcname, alltests[iat], torun)
                } catch (err) {
                  console.log("    complete function failure while testing:", funcname,":args:", torun, ":results:", res)
                  res="TEST FAILURE"
                }
              } else {
          ...
          console.log("    unable to find function: " + funcname)
        }
      }
    } catch (err) {
